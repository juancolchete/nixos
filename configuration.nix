...
in {
  ...
  system.activationScripts.rustup = ''
    PATH=${pkgs.rustup}/bin:/home/juanc/.cargo/bin:${pkgs.curl}/bin:${pkgs.bash}/bin:run/current-system/sw/bin:/nix/store/8rq01kg6lng5d1fz5wd0mfn2yjaww9sq-system-path/bin/tar:/run/current-system/sw/bin/clang:/bin/dfx:$PATH
